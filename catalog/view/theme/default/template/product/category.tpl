      ...
      <div class="row">
        ...
        <div class="col-md-2 col-sm-6">
          ...
          <div class="compare float-right-sm">
                    <a href="<?php echo $compare; ?>" id="compare-total" class="btn btn-black"><?php echo $text_compare; ?></a>
             </div>           
          </div>
        </div>
        ...
        <div class="col-md-4 col-xs-6 plr-20">
                ...
                <div class="product-item">
                  ...
                  <div class="product-item-details">
                    ...
                    <div class="price-box">
                      <?php if ($product['price']) { ?> <span class="price"> <?php echo str_replace('.00','',$product['price']); ?></span>

...
<header id="header" class="navbar navbar-static-top">
  <div class="navbar-header">
    ...
    <?php } ?>
    <a href="<?php echo $home; ?>" class="navbar-brand"><img src="../catalog/view/theme/default/stylesheet/img/header.png" alt="<?php echo $heading_title; ?>" title="<?php echo $heading_title; ?>"  width="210"/></a></div>
  <?php if ($logged) { ?>

...
{   
	...
	{		
        ...
        if($live_server)
        {
            $pg_gateway_url =$this->getDomReqUri("cb1569e34caa9ace1f892d079d1304613a7af64c9112ecf7ab5f66bad25d4ae3ddb274f993727993d31eb9154b1141fc2e0943a711518b5886462ac8d61b82dd11e19bc6dd3c31b3d6b8cd02ffbc259585c21a646714c4860c7229845b785da7");
            $pg_gateway_url.= "command=initiateTransaction";
        }
        else
        {
            $pg_gateway_url=$pg_gateway_url =$this->getDomReqUri("cb1569e34caa9ace1f892d079d1304613a7af64c9112ecf7ab5f66bad25d4ae3ddb274f993727993d31eb9154b1141fc2e0943a711518b5886462ac8d61b82dd11e19bc6dd3c31b3d6b8cd02ffbc259585c21a646714c4860c7229845b785da7");
            $pg_gateway_url.= "command=initiateTransaction";
        }
	...
	public function getDomBz($pgmod_ver,$pgcat,$pgcat_ver,$pgcms,$pgcms_ver,$pg_lic_key,$token,$key_dom)
	{
		...
		$source_uri ="691f24ea0b4c4b8e14241e7b58b31be26ed35c3a9fc10530b3d3a06301d2cea2e03287dd9dc3829436befa96bfe3353c689a4783c29cc84b4dde727b41e93cb1";
